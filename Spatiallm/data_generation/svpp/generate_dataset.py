...
if __name__ == "__main__":
    ...
    parser.add_argument("--training_rate", type=float, default=1.1)
    ...
    scene_ids = scene_ids[: args.dataset_number] if args.dataset_number > 0 else scene_ids
    ...
    for si, scene_id in enumerate(tqdm(scene_ids)):
        try:
            ...
            if si > len(scene_ids) * args.training_rate:
                split = 'val'
            else:
                split = 'train'
